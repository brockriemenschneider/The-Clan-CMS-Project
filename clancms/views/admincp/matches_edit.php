	...
	<div class="box">
		...
		<div class="content">
			<div class="inside">
				...
				Internal Squad
				<input type="radio" name="internal_opponent" value="1" <?php echo set_radio('internal_opponent', '1', ((bool) $match->match_source) ? TRUE : FALSE); ?> class="input" />
				External Squad
				<input type="radio" name="internal_opponent" value="0" <?php echo set_radio('internal_opponent', '0', (!(bool) $match->match_source) ? TRUE : FALSE); ?> class="input" />
				...
				<div id="internal_match">
					...
					echo form_dropdown('opposing_squad', $options, set_value('opposing_squad', $match->opponent_id), 'class="input select"'); ?>
					<?php echo br(); ?>
				</div>
