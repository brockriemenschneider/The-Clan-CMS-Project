...
<div id="header">
	...
	<div id="banner"><?php if((bool) $this->ClanCMS->get_setting('logo')): ?><?php echo anchor('', img(array('src' => THEME_URL . 'images/logo.png', 'alt' => 'Logo', 'id' => 'logo'))); ?><?php elseif($this->ClanCMS->get_setting('logo') == 2): ?><?php echo anchor('', '<h1>' . CLAN_NAME . '</h1><h2>' . $this->ClanCMS->get_setting('clan_slogan') . '</h2>'); ?><?php endif; ?></div>
	<div id="navigation">
	<ul>
