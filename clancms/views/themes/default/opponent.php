		...
		<table>
			...
			<tbody>
				...
				<tr class="row">
					...
					<td <?php if($match->match_opponent_score > $match->match_score): echo 'class="green"'; elseif($match->match_opponent_score < $match->match_score): echo 'class="red"'; elseif($match->match_opponent_score == $match->match_score && $match->match_date < mdate('%Y-%m-%d %H:%i:%s', local_to_gmt(time()))): echo 'class="yellow"'; else: echo ''; endif;?>><?php if($match->match_date < mdate('%Y-%m-%d %H:%i:%s', local_to_gmt(time()))): echo $match->match_opponent_score . ' - ' . $match->match_score; else: echo '-'; endif; ?></td>
