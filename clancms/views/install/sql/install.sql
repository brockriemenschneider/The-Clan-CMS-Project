...
(1, 1, 'Clan Name', 'clan_name', '__CLANNAME__', 'input', 'Put your clan name here.', 1),
(2, 2, 'Theme', 'theme', 'default', 'input', 'The name of the theme folder you want to use.', 1),
(3, 3, 'Default Timezone', 'default_timezone', '__TIMEZONE__', 'timezone', 'The default timezone for entire site', 1),
(4, 1, 'Site Email', 'site_email', '__SITEEMAIL__', 'input', 'The site''s main email', 4),
(5, 3, 'Daylight Savings', 'daylight_savings', '__DAYLIGHTSAVINGS__', 'dropdown', 'Is it daylight savings?', 2),
