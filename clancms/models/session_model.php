...
class Session_model extends CI_Model {
	 ...
	 * Has Voice
	 *
	 * Check's to see if a user is can comment
	 *
	 * @access	public
	 * @return	bool
	 */
	function has_voice()	
	{
		...
		// Cross-check and see if user can shout
		if($this->users->get_user($data))
		{
			// User can speak, return TRUE
			return TRUE;
		}
		else
		{
			// User doesn't exist or has been muted, return FALSE
			return FALSE;
		}
	}
	 ...
	 * Can Shout
	 *
	 * Check's to see if a user use shoutbox
	 *
	 * @access	public
	 * @return	bool
	 */
	function can_shout()	
	{
		...
		if(!$this->has_voice())
		{
			// User has been muted, return FALSE
			return FALSE;
		}
		...
		if($this->users->get_user($data))
		{
			// User exists and can shout, return TRUE
			return TRUE;
		}
		else
		{
			// User doesn't exist or cannot shout, return FALSE
			return FALSE;
		}
	}
	 ...
	 * Can Upload
	 *
	 * Check's to see if a user can upload
	 *
	 * @access	public
	 * @return	bool
	 */
	function can_upload()	
	{
		...
		if($this->users->get_user($data))
		{
			// User exists and may upload, return TRUE
			return TRUE;
		}
		else
		{
			// User doesn't exist or may not upload, return FALSE
			return FALSE;
		}
	}
