...
// --------------------------------------------------------------------
	 ...
	 * Get Category
	 *
	 * Retrieves a article category from the database
	 *
	 * @access	public
	 * @param	array
	 * @return	array
	...
	{	
		...
		// Data is valid, slide exists, delete the data from the database
		return $this->db->delete('article_categories', array('category_id' => $category_id));
	}
		// --------------------------------------------------------------------
