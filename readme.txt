...
1) Upload all the files to your server except the upgrade folder
...
1) Upload all the files in the upgrade folder which should replace the old files on your server

2) In the Admin CP Click "Resolve Now" on the pending manual upgrade alert to finish the upgrade